...
namespace FileSplitter.Hashing
{
    ...
    public class CRC32 : HashAlgorithm
    {
        ...
        {
            string ret;
            ret= BitConverter.ToString(HashFinal(), 0).Replace("-", "");
            return ret;
        }
    }
}
